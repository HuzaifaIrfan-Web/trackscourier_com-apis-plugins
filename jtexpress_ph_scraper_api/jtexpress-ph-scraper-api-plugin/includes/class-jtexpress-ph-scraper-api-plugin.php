...
class jtexpress_ph_Scraper_Api_Plugin {
	...
	public function __construct() {
		...
		$this->plugin_name = 'jtexpress-ph-scraper-api-plugin';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jtexpress-ph-scraper-api-plugin-loader.php';
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-jtexpress-ph-scraper-api-plugin-admin.php';
