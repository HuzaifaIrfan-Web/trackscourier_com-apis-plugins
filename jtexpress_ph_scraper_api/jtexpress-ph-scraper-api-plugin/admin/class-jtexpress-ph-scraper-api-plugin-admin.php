...
class jtexpress_ph_Scraper_Api_Plugin_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/jtexpress-ph-scraper-api-plugin-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/jtexpress-ph-scraper-api-plugin-admin.js', array( 'jquery' ), $this->version, false );
